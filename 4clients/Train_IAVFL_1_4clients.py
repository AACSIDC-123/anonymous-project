...
def train_client(dataloader, client_student_model_1, client_student_model_2, \
    ...
    for batch_id, batch in enumerate(dataloader):
        ...
        X_1_non_overlap = torch.cat([X_1_complete2, X_1_complete3, X_1_complete4], dim=0)
        ...
        Y_non_overlap = torch.cat([Y_complete2, Y_complete3, Y_complete4], dim=0)
        ...
        # -----client1--overlap-----
        # ***overlap_client***
        fx1_student = client_student_model_1(X_1_overlap)
        ...
        # ***overlap_server***
        T = 2.0  
        _, server_student = server_student_model(fx1_student)
        ...
        optimizer_student_client1.zero_grad()
        loss.backward()
        optimizer_student_server.step()
        optimizer_student_client1.step()
        ...
        # -----client1--non_overlap-----
        # ***non-overlap_client***
        fx1 = client_student_model_1(X_1_non_overlap)

        # ***non-overlap_server***
        _, server_fx1 = server_student_model(fx1)
        
        loss = criterion(server_fx1, Y_non_overlap)  
        ...
        correct_non_overlap += (server_fx1.argmax(1) == Y_non_overlap).type(torch.float).sum().item()
        ...
        if batch_id == args.num_batch-1:
            ...
            accuracy = correct_all / (args.num_batch*(args.num_overlap+num_complete2+num_complete3+num_complete4))
...
def test_client(dataloader, client_student_model_1, client_student_model_2, \
    ...
    for batch_id, batch in enumerate(dataloader):
        ...
        for i, missing_ratio in enumerate(missing_ratios):
            ...
            fx1 = client_student_model_1(X1_blank)
            client_1_embeddings.append(fx1.clone().detach().requires_grad_(True))
        
        for i, client_1_embedding in enumerate(client_1_embeddings):
        
            _, fx_server = server_student_model(client_1_embedding)
        ...
        if batch_id == len(dataloader) - 1:
            ...
            if correct[0] > correct_best:
                ...
                save_path1 = f'Result/Results_IAVFL_1_4clients/Results_batchsize{args.batch_size}/learningRate{args.lr}/Seed{args.seed}/{args.dataset}/{args.model}-level{args.level}/client{args.number_client}-c{args.num_cutlayer}/samples{args.num_batch*args.batch_size}/overlap{args.num_overlap*args.num_batch}/client1_best.pth'
                # save_path2 = f'Result/Results_IAVFL_1_4clients/Results_batchsize{args.batch_size}/learningRate{args.lr}/Seed{args.seed}/{args.dataset}/{args.model}-level{args.level}/client{args.number_client}-c{args.num_cutlayer}/samples{args.num_batch*args.batch_size}/overlap{args.num_overlap*args.num_batch}/client2_best.pth'
                # save_path3 = f'Result/Results_IAVFL_1_4clients/Results_batchsize{args.batch_size}/learningRate{args.lr}/Seed{args.seed}/{args.dataset}/{args.model}-level{args.level}/client{args.number_client}-c{args.num_cutlayer}/samples{args.num_batch*args.batch_size}/overlap{args.num_overlap*args.num_batch}/client3_best.pth'
                # save_path4 = f'Result/Results_IAVFL_1_4clients/Results_batchsize{args.batch_size}/learningRate{args.lr}/Seed{args.seed}/{args.dataset}/{args.model}-level{args.level}/client{args.number_client}-c{args.num_cutlayer}/samples{args.num_batch*args.batch_size}/overlap{args.num_overlap*args.num_batch}/client4_best.pth'
                save_server_path = f'Result/Results_IAVFL_1_4clients/Results_batchsize{args.batch_size}/learningRate{args.lr}/Seed{args.seed}/{args.dataset}/{args.model}-level{args.level}/client{args.number_client}-c{args.num_cutlayer}/samples{args.num_batch*args.batch_size}/overlap{args.num_overlap*args.num_batch}/server_best.pth'
...
if __name__ == '__main__':
    ...
    save_path = f'Result/Results_IAVFL_1_4clients/Results_batchsize{args.batch_size}/learningRate{args.lr}/Seed{args.seed}/{args.dataset}/{args.model}-level{args.level}/client{args.number_client}-c{args.num_cutlayer}/samples{args.num_batch*args.batch_size}/overlap{args.num_overlap*args.num_batch}/'
    if not os.path.exists(save_path):
        os.makedirs(save_path)
    filename = open(f'Result/Results_IAVFL_1_4clients/Results_batchsize{args.batch_size}/learningRate{args.lr}/Seed{args.seed}/{args.dataset}/{args.model}-level{args.level}/client{args.number_client}-c{args.num_cutlayer}/samples{args.num_batch*args.batch_size}/overlap{args.num_overlap*args.num_batch}/A_training_process.txt', 'w+')
    ...
    #save
    np.save(f'Result/Results_IAVFL_1_4clients/Results_batchsize{args.batch_size}/learningRate{args.lr}/Seed{args.seed}/{args.dataset}/{args.model}-level{args.level}/client{args.number_client}-c{args.num_cutlayer}/samples{args.num_batch*args.batch_size}/overlap{args.num_overlap*args.num_batch}/train_acc.npy', train_acc) 
    np.save(f'Result/Results_IAVFL_1_4clients/Results_batchsize{args.batch_size}/learningRate{args.lr}/Seed{args.seed}/{args.dataset}/{args.model}-level{args.level}/client{args.number_client}-c{args.num_cutlayer}/samples{args.num_batch*args.batch_size}/overlap{args.num_overlap*args.num_batch}/train_loss.npy', train_loss)
    np.save(f'Result/Results_IAVFL_1_4clients/Results_batchsize{args.batch_size}/learningRate{args.lr}/Seed{args.seed}/{args.dataset}/{args.model}-level{args.level}/client{args.number_client}-c{args.num_cutlayer}/samples{args.num_batch*args.batch_size}/overlap{args.num_overlap*args.num_batch}/test_acc.npy', test_acc) 
    ...
    plt.legend()
    plt.savefig(f'Result/Results_IAVFL_1_4clients/Results_batchsize{args.batch_size}/learningRate{args.lr}/Seed{args.seed}/{args.dataset}/{args.model}-level{args.level}/client{args.number_client}-c{args.num_cutlayer}/samples{args.num_batch*args.batch_size}/overlap{args.num_overlap*args.num_batch}/A_train_acc.png')
    plt.close()
    ...
    plt.legend()
    plt.savefig(f'Result/Results_IAVFL_1_4clients/Results_batchsize{args.batch_size}/learningRate{args.lr}/Seed{args.seed}/{args.dataset}/{args.model}-level{args.level}/client{args.number_client}-c{args.num_cutlayer}/samples{args.num_batch*args.batch_size}/overlap{args.num_overlap*args.num_batch}/A_train_loss.png')
    plt.close()
    ...
    plt.legend()
    plt.savefig(f'Result/Results_IAVFL_1_4clients/Results_batchsize{args.batch_size}/learningRate{args.lr}/Seed{args.seed}/{args.dataset}/{args.model}-level{args.level}/client{args.number_client}-c{args.num_cutlayer}/samples{args.num_batch*args.batch_size}/overlap{args.num_overlap*args.num_batch}/A_test_acc.png')
    plt.close()
