...
def train_client(dataloader, client_student_model_1, client_student_model_2, \
    ...
    for batch_id, batch in enumerate(dataloader):
        ...
        X_4_non_overlap = torch.cat([X_4_complete1, X_4_complete2, X_4_complete3], dim=0)
        ...
        Y_non_overlap = torch.cat([Y_complete1, Y_complete2, Y_complete3], dim=0)
        ...
        # -----client4--overlap-----
        # ***overlap_client***
        fx4_student = client_student_model_4(X_4_overlap)
        ...
        # ***overlap_server***
        T = 2.0  
        _, server_student = server_student_model(fx4_student)
        ...
        optimizer_student_client4.zero_grad()
        loss.backward()
        optimizer_student_server.step()
        optimizer_student_client4.step()
        ...
        # -----client4--non_overlap-----
        # ***non-overlap_client***
        fx4 = client_student_model_4(X_4_non_overlap)

        # ***non-overlap_server***
        _, server_fx4 = server_student_model(fx4)
        
        loss = criterion(server_fx4, Y_non_overlap)  
        ...
        correct_non_overlap += (server_fx4.argmax(1) == Y_non_overlap).type(torch.float).sum().item()
        ...
        if batch_id == args.num_batch -1:
            ...
            accuracy = correct_all / (args.num_batch*(args.num_overlap+num_complete1+num_complete2+num_complete3))
...
def test_client(dataloader, client_student_model_1, client_student_model_2, \
    ...
    for batch_id, batch in enumerate(dataloader):
        ...
        for i, missing_ratio in enumerate(missing_ratios):
            ...
            fx4 = client_student_model_4(X4_blank)
            client_4_embeddings.append(fx4.clone().detach().requires_grad_(True))
        
        for i, client_4_embedding in enumerate(client_4_embeddings):
        
            _, fx_server = server_student_model(client_4_embedding)
        ...
        if batch_id == len(dataloader) - 1:
            ...
            if correct[0] > correct_best:
                ...
                #save_path1 = f'Result/Results_IAVFL_4_4clients/Results_batchsize{args.batch_size}/learningRate{args.lr}/Seed{args.seed}/{args.dataset}/{args.model}-level{args.level}/client{args.number_client}-c{args.num_cutlayer}/samples{args.num_batch*args.batch_size}/overlap{args.num_overlap*args.num_batch}/client1_best.pth'
                #save_path2 = f'Result/Results_IAVFL_4_4clients/Results_batchsize{args.batch_size}/learningRate{args.lr}/Seed{args.seed}/{args.dataset}/{args.model}-level{args.level}/client{args.number_client}-c{args.num_cutlayer}/samples{args.num_batch*args.batch_size}/overlap{args.num_overlap*args.num_batch}/client2_best.pth'
                #save_path3 = f'Result/Results_IAVFL_4_4clients/Results_batchsize{args.batch_size}/learningRate{args.lr}/Seed{args.seed}/{args.dataset}/{args.model}-level{args.level}/client{args.number_client}-c{args.num_cutlayer}/samples{args.num_batch*args.batch_size}/overlap{args.num_overlap*args.num_batch}/client3_best.pth'
                save_path4 = f'Result/Results_IAVFL_4_4clients/Results_batchsize{args.batch_size}/learningRate{args.lr}/Seed{args.seed}/{args.dataset}/{args.model}-level{args.level}/client{args.number_client}-c{args.num_cutlayer}/samples{args.num_batch*args.batch_size}/overlap{args.num_overlap*args.num_batch}/client4_best.pth'
                save_server_path = f'Result/Results_IAVFL_4_4clients/Results_batchsize{args.batch_size}/learningRate{args.lr}/Seed{args.seed}/{args.dataset}/{args.model}-level{args.level}/client{args.number_client}-c{args.num_cutlayer}/samples{args.num_batch*args.batch_size}/overlap{args.num_overlap*args.num_batch}/server_best.pth'
...
if __name__ == '__main__':
    ...
    save_path = f'Result/Results_IAVFL_4_4clients/Results_batchsize{args.batch_size}/learningRate{args.lr}/Seed{args.seed}/{args.dataset}/{args.model}-level{args.level}/client{args.number_client}-c{args.num_cutlayer}/samples{args.num_batch*args.batch_size}/overlap{args.num_overlap*args.num_batch}/'
    if not os.path.exists(save_path):
        os.makedirs(save_path)
    filename = open(f'Result/Results_IAVFL_4_4clients/Results_batchsize{args.batch_size}/learningRate{args.lr}/Seed{args.seed}/{args.dataset}/{args.model}-level{args.level}/client{args.number_client}-c{args.num_cutlayer}/samples{args.num_batch*args.batch_size}/overlap{args.num_overlap*args.num_batch}/A_training_process.txt', 'w+')
    ...
    #save
    np.save(f'Result/Results_IAVFL_4_4clients/Results_batchsize{args.batch_size}/learningRate{args.lr}/Seed{args.seed}/{args.dataset}/{args.model}-level{args.level}/client{args.number_client}-c{args.num_cutlayer}/samples{args.num_batch*args.batch_size}/overlap{args.num_overlap*args.num_batch}/train_acc.npy', train_acc) 
    np.save(f'Result/Results_IAVFL_4_4clients/Results_batchsize{args.batch_size}/learningRate{args.lr}/Seed{args.seed}/{args.dataset}/{args.model}-level{args.level}/client{args.number_client}-c{args.num_cutlayer}/samples{args.num_batch*args.batch_size}/overlap{args.num_overlap*args.num_batch}/train_loss.npy', train_loss)
    np.save(f'Result/Results_IAVFL_4_4clients/Results_batchsize{args.batch_size}/learningRate{args.lr}/Seed{args.seed}/{args.dataset}/{args.model}-level{args.level}/client{args.number_client}-c{args.num_cutlayer}/samples{args.num_batch*args.batch_size}/overlap{args.num_overlap*args.num_batch}/test_acc.npy', test_acc) 
    ...
    plt.legend()
    plt.savefig(f'Result/Results_IAVFL_4_4clients/Results_batchsize{args.batch_size}/learningRate{args.lr}/Seed{args.seed}/{args.dataset}/{args.model}-level{args.level}/client{args.number_client}-c{args.num_cutlayer}/samples{args.num_batch*args.batch_size}/overlap{args.num_overlap*args.num_batch}/A_train_acc.png')
    plt.close()
    ...
    plt.legend()
    plt.savefig(f'Result/Results_IAVFL_4_4clients/Results_batchsize{args.batch_size}/learningRate{args.lr}/Seed{args.seed}/{args.dataset}/{args.model}-level{args.level}/client{args.number_client}-c{args.num_cutlayer}/samples{args.num_batch*args.batch_size}/overlap{args.num_overlap*args.num_batch}/A_train_loss.png')
    plt.close()
    ...
    plt.legend()
    plt.savefig(f'Result/Results_IAVFL_4_4clients/Results_batchsize{args.batch_size}/learningRate{args.lr}/Seed{args.seed}/{args.dataset}/{args.model}-level{args.level}/client{args.number_client}-c{args.num_cutlayer}/samples{args.num_batch*args.batch_size}/overlap{args.num_overlap*args.num_batch}/A_test_acc.png')
    plt.close()
