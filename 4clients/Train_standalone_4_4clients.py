...
def train_server(client4_fx, Y_1, t, batch_id, correct, server_model, num_All, size):
    server_model.train()
    correct = correct

    _, server_result = server_model(client4_fx)
...
def train_client(dataloader, client_model_4, server_model, t):
    ...
    for batch_id, batch in enumerate(dataloader):
        ...
        X_4_All = torch.cat([X_4_overlap, X_4_complete1, X_4_complete2, X_4_complete3], dim=0)
        ...
        Y_All = torch.cat([Y_overlap, Y_complete1, Y_complete2, Y_complete3], dim=0)
        ...
        num_All = args.num_overlap + num_complete1 + num_complete2 + num_complete3
        
        # client1--train and update
        fx4 = client_model_4(X_4_All)
        # Sending activations to server and receiving gradients from server
        client4_fx = (fx4).clone().detach().requires_grad_(True)
        g_fx4, correct = train_server(client4_fx, Y_All, t, batch_id, correct, server_model, num_All, size)
        ...
        if (t+1) %10 ==0 or t == args.epochs-1:
            if batch_id == args.num_overlap-1:  
                # save_path1 = f'Result/Results_standalone4_4clients/Results_batchsize{args.batch_size}/Seed{args.seed}/nonoverlap1_ratio_{args.nonoverlap1_ratio}/{args.dataset}/iclasses{args.classes}/{args.model}-level{args.level}/client{args.number_client}-c{args.num_cutlayer}/samples{args.num_batch*args.batch_size}/overlap{args.num_overlap*args.num_batch}/client1_epoch{t+1}.pth'
                save_path4 = f'Result/Results_standalone4_4clients/Results_batchsize{args.batch_size}/Seed{args.seed}/nonoverlap1_ratio_{args.nonoverlap1_ratio}/{args.dataset}/iclasses{args.classes}/{args.model}-level{args.level}/client{args.number_client}-c{args.num_cutlayer}/samples{args.num_batch*args.batch_size}/overlap{args.num_overlap*args.num_batch}/client4_epoch{t+1}.pth'
...
def test_server(dataloader, client_4_embeddings, Y_1, batch_id, correct, loss, server_model, size, t):
    ...
    for i, client_4_embedding in enumerate(client_4_embeddings):
        ...
        optimizer_server.zero_grad()
        _, fx_server = server_model(client_4_embedding)
...
def test_client(dataloader, client_model_4, server_model, t):
    ...
    for batch_id, batch in enumerate(dataloader):
        ...
        # Sending activations to server and receiving gradients from server
        correct, loss = test_server(dataloader, client_4_embeddings, Y_1, batch_id, correct, loss, server_model, size, t)
...
if __name__ == '__main__':
    ...
    save_path = f'Result/Results_standalone4_4clients/Results_batchsize{args.batch_size}/Seed{args.seed}/nonoverlap1_ratio_{args.nonoverlap1_ratio}/{args.dataset}/iclasses{args.classes}/{args.model}-level{args.level}/client{args.number_client}-c{args.num_cutlayer}/samples{args.num_batch*args.batch_size}/overlap{args.num_overlap*args.num_batch}/'
    if not os.path.exists(save_path):
        os.makedirs(save_path)
    filename = open(f'Result/Results_standalone4_4clients/Results_batchsize{args.batch_size}/Seed{args.seed}/nonoverlap1_ratio_{args.nonoverlap1_ratio}/{args.dataset}/iclasses{args.classes}/{args.model}-level{args.level}/client{args.number_client}-c{args.num_cutlayer}/samples{args.num_batch*args.batch_size}/overlap{args.num_overlap*args.num_batch}/A_training_process.txt', 'w+')
    ...
    # Define model----should be changed to 4 clients
    ...
    for t in range(args.epochs):
        ...
        train_client(train_data, client_model_4, server_model, t)
        test_client(test_data, client_model_4, server_model, t)
    ...
    #save
    np.save(f'Result/Results_standalone4_4clients/Results_batchsize{args.batch_size}/Seed{args.seed}/nonoverlap1_ratio_{args.nonoverlap1_ratio}/{args.dataset}/iclasses{args.classes}/{args.model}-level{args.level}/client{args.number_client}-c{args.num_cutlayer}/samples{args.num_batch*args.batch_size}/overlap{args.num_overlap*args.num_batch}/train_acc.npy', train_acc) 
    ...
    plt.legend()
    plt.savefig(f'Result/Results_standalone4_4clients/Results_batchsize{args.batch_size}/Seed{args.seed}/nonoverlap1_ratio_{args.nonoverlap1_ratio}/{args.dataset}/iclasses{args.classes}/{args.model}-level{args.level}/client{args.number_client}-c{args.num_cutlayer}/samples{args.num_batch*args.batch_size}/overlap{args.num_overlap*args.num_batch}/A_train_acc.png')
    plt.close()
